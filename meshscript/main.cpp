...
void* register_functions(void*)
  ...
  register_external_primitive("save", (void*)&scm_write, skiwi_bool, skiwi_int64, skiwi_char_pointer, "(save id \"file.ext\") writes the object with tag `id` to file. The filetype is determined by the extension that is given. You can export meshes to STL, PLY, OBJ, or TRC, pointclouds to PLY, OBJ, or TRC, morphable models to SSM."); // don't use write: gives naming conflict with slib
